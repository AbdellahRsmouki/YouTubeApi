...
public class swipButtonAnim extends RelativeLayout {

    private static final String TAG = swipButtonAnim.class.getSimpleName();
    ...
    public swipButtonAnim(Context context) {
        super(context);

        init(context, null, -1, -1);
    }

    public swipButtonAnim(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs, -1, -1);
    }

    public swipButtonAnim(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public swipButtonAnim(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
